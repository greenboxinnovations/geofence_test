...
0. Read http://stackoverflow.com/questions/217578/how-can-i-determine-whether-a-2d-point-is-within-a-polygon
1. A bouding box for each geofence is calculated as a first pass
2. If points are within the bounding box, then ray intersection is calculated to check number of intersections,
3. If number of intersections is odd, the point is within the geofence, 
4. If number of intersections is even it isnt
